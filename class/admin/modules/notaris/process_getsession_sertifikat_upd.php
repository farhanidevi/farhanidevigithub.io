<?php
	...
	if(isset($_SESSION['sertifikat_upd'])) {
		for($i = 0; $i < count($_SESSION['sertifikat_upd']); $i++) {
			$id_kab = abs($_SESSION['sertifikat_upd'][$i]['id_kabupaten']);
			...
			$id_kec = $_SESSION['sertifikat_upd'][$i]['id_kecamatan'];
			...
			$res[0]['nomor'] = $_SESSION['sertifikat_upd'][$i]['nomor'];
			$res[0]['id_kabupaten'] = $_SESSION['sertifikat_upd'][$i]['id_kabupaten'];
			$res[0]['id_kecamatan'] = $_SESSION['sertifikat_upd'][$i]['id_kecamatan'];
